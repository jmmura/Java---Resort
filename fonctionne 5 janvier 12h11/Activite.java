...
//    }
    ...
    public static void afficherMembres(){
        for(String s : listeActivites.keySet()){
            Activite act = listeActivites.get(s);
            System.out.print(act.getNom()+" : ");
            for(Personne p : act.getMembres()){
